...
const std::vector<std::vector<std::string>> STORAGE_NODES{
    {""},                                                                                              // 0 to allow direct offset
    {"172.18.94.80"},                                                                                  // 1
    {"172.18.94.80", "172.18.94.70"},                                                                  // 2
    {"172.18.94.80", "172.18.94.70", "172.18.94.60"},                                                  // 3
    {"172.18.94.80", "172.18.94.70", "172.18.94.60", "172.18.94.40"},                                  // 4
    {"172.18.94.80", "172.18.94.70", "172.18.94.60", "172.18.94.40", "172.18.94.50"},                  // 5
    {"172.18.94.80", "172.18.94.70", "172.18.94.60", "172.18.94.40", "172.18.94.50", "172.18.94.30"},  // 6
};
...
static constexpr uint64_t MAX_REGIONS = 10;
